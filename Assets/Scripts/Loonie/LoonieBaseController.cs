...
public class LoonieBaseController : MonoBehaviour
{
	...
	public float playerReachedThreshold = 1.7f; // Adjust by hand for now
	public float distanceFromHomeThresh = 15.0f;
	public float homeReachedThreshold  = 1.0f;
...
//============================ STATE CHECKS ==================================//
	...
	protected virtual bool IsPlayerReached()
	{
		...
		if(distance < playerReachedThreshold)
		{
			return true;
		}
		return false;
	...
	{
		if((defaultPosition - transform.position).magnitude <  homeReachedThreshold)
		{
			return true;
		}
		return false;
