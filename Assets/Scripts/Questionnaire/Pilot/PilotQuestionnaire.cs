...
public class PilotQuestionnaire : MonoBehaviour {
	...
	void OnGUI () {
		...
		else if(personalityPageIndex >= pilotPages.Length)
		{
			// End of questionnaire
			GUI.Label(layout.ElementRectRange(0,3,1,4), "Thanks for your participation in the pilot test!\nIt is now safe to go back to real life.", "box");
